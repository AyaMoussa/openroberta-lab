...
public final class EvalExpr extends Expr {
    ...
    public EvalExpr(String exprAsString, Expr exprBlock, BlocklyType type, BlocklyProperties properties) throws Exception {
        ...
        if ( exprBlock instanceof ExprList ) {
            ...
            String blocklyName = this.type.getBlocklyName();
    ...
    public BlocklyType getVarType() {
        return this.exprAsBlock.getVarType();
    }
    ...
    public Block ast2xml() {
        if ( true ) {
            ...
            mutation.setType(this.type.getBlocklyName());
            Ast2Jaxb.setBasicProperties(this, jaxbDestination);
            Ast2Jaxb.addField(jaxbDestination, BlocklyConstants.TYPE, this.type.name());
